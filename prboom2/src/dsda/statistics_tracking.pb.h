...
class KillStatistic final :
 ...
 public:
  ...
  KillStatistic* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  uint64_t weapon_id() const;
  void set_weapon_id(uint64_t value);
  private:
  uint64_t _internal_weapon_id() const;
  void _internal_set_weapon_id(uint64_t value);
  public:
...
class EnemyKillStatistics final :
 ...
 public:
  ...
  EnemyKillStatistics* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  // uint64 enemy_id = 1;
  void clear_enemy_id();
  uint64_t enemy_id() const;
  void set_enemy_id(uint64_t value);
  private:
  uint64_t _internal_enemy_id() const;
...
class KillStatistics final :
 ...
 public:
  ...
  KillStatistics* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class Statistics final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::statistics::protocol::KillStatistics* release_kill();
...
inline uint64_t KillStatistic::_internal_weapon_id() const {
  return weapon_id_;
}
inline uint64_t KillStatistic::weapon_id() const {
  // @@protoc_insertion_point(field_get:statistics.protocol.KillStatistic.weapon_id)
  return _internal_weapon_id();
}
inline void KillStatistic::_internal_set_weapon_id(uint64_t value) {
  
  weapon_id_ = value;
}
inline void KillStatistic::set_weapon_id(uint64_t value) {
...
inline uint64_t KillStatistic::_internal_count() const {
  return count_;
}
inline uint64_t KillStatistic::count() const {
  // @@protoc_insertion_point(field_get:statistics.protocol.KillStatistic.count)
  return _internal_count();
}
inline void KillStatistic::_internal_set_count(uint64_t value) {
  
  count_ = value;
}
inline void KillStatistic::set_count(uint64_t value) {
...
inline uint64_t EnemyKillStatistics::_internal_enemy_id() const {
  return enemy_id_;
}
inline uint64_t EnemyKillStatistics::enemy_id() const {
  // @@protoc_insertion_point(field_get:statistics.protocol.EnemyKillStatistics.enemy_id)
  return _internal_enemy_id();
}
inline void EnemyKillStatistics::_internal_set_enemy_id(uint64_t value) {
  
  enemy_id_ = value;
}
inline void EnemyKillStatistics::set_enemy_id(uint64_t value) {
